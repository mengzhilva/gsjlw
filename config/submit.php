...
if($act=="2")
{
	...
	{ 
		if($a->PactNumber==$connumber)
		{
			...
			{
				$GLOBALS["db"]->query("insert into process_manage (truename,mobile,connumber,address,uid,isdefault) values ('".$a->Name ."','".$a->CellPhone ."','".$a->PactNumber ."','".$a->Address ."',$uid,$isdefault)");
				$succ=1;				
			}
			else
			{
